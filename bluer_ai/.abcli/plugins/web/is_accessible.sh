...
export BLUER_AI_IS_ONLINE=$(bluer_ai_web_is_accessible https://arvancloud.ir)
export INTERNET_IS_NATIONAL=$(bluer_ai_not $(bluer_ai_web_is_accessible https://github.com))
