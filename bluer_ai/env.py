...
BLUER_AI_INTERNET_ONLINE_CHECK_URL = get_env("BLUER_AI_INTERNET_ONLINE_CHECK_URL")

BLUER_AI_INTERNET_NATIONAL_CHECK_URL = get_env("BLUER_AI_INTERNET_NATIONAL_CHECK_URL")
