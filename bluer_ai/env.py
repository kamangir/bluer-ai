...
BLUER_AI_INTERNET_INSIDE_CHECK_URL = get_env("BLUER_AI_INTERNET_INSIDE_CHECK_URL")

BLUER_AI_INTERNET_OUTSIDE_CHECK_URL = get_env("BLUER_AI_INTERNET_OUTSIDE_CHECK_URL")
