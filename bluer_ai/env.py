...
BLUER_AI_CLOUD_CHECK_URL = get_env("BLUER_AI_CLOUD_CHECK_URL")
...
BLUER_AI_SBC_PASSWORD = get_env("BLUER_AI_SBC_PASSWORD")

BLUER_AI_IGNORED_EXTERNAL_PLUGINS = get_env("BLUER_AI_IGNORED_EXTERNAL_PLUGINS")
