...
function abcli_refresh_branch_and_version() {
    export abcli_version=$(python3 -c "import blue_ai; print(blue_ai.VERSION)")

    export abcli_git_branch=$(abcli_git blue-ai get_branch)

    export abcli_fullname=blue_ai-$abcli_version.$abcli_git_branch
}
